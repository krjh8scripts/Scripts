...
OrionLib:MakeNotification({
	...
	Content = "Game : Soccer Proâš½(3v3)",
	Image = "rbxassetid://4483345998",
	Time = 5
})

local Window = OrionLib:MakeWindow({Name = "Latvix Hub - Soccer Proâš½(3v3)", HidePremium = false, SaveConfig = true, ConfigFolder = "j", IntroText = "Latvix Hub"})
